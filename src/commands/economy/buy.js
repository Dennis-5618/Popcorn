...
module.exports = {
    ...
    run: async (client, message, args) => {
        const item = shopItems.find((value) => value.id);
        ...
        if (data.userInventory.includes(item.id)) return message.channel.send("You already have that item in your inventory");
